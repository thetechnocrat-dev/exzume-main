...
var FitnessCard = React.createClass({
  propTypes: {
    ...
    exercisesThisWeek: React.PropTypes.number.isRequired,
    avgExercisesPerWeek: React.PropTypes.number.isRequired,
  },
